...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.timeenc == 0:
            #df_stamp['month'] = df_stamp.date.apply(lambda row: row.month, 1)       #这里把除了weekly之外的都注释掉了
...
class Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        tmp_stamp['date'] = pd.to_datetime(tmp_stamp.date, format='mixed',errors='ignore' )   #这里加了个errors='ignore'
